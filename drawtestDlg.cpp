...
BEGIN_MESSAGE_MAP(CdrawtestDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CdrawtestDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CdrawtestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CdrawtestDlg::OnBnClickedButton1()
{
	...
	double X1Values[404], Y1Values[404],str[404];
